...
namespace BlogSpa.Data.EF.Helpers
{
    /// <summary>
    ...
    public class RepositoryProvider : IRepositoryProvider
    {
        ...
        /// <summary>
        /// Get or create-and-cache the default <see cref="IBlogRepository{T}"/> for an entity of type T.
        /// </summary>
        /// <typeparam name="T">
        /// Root entity type of the <see cref="IBlogRepository{T}"/>.
        /// </typeparam>
        /// <remarks>
        /// If can't find repository in cache, use a factory to create one.
        /// </remarks>
        public IBlogRepository<T> GetRepositoryForEntityType<T>() where T : class
        {
            return GetRepository<IBlogRepository<T>>(
